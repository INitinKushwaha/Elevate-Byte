  ...
  return (
    <header className="relative min-h-screen flex items-center justify-center bg-hero overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center z-10">
        <h1 className="text-4xl sm:text-5xl font-extrabold">Connecting Top Tech Talent with Leading US Companies</h1>
        <p className="mt-4 text-slate-600 max-w-2xl mx-auto">Elevate careers and empower organizations through seamless IT recruitment solutions.</p>
